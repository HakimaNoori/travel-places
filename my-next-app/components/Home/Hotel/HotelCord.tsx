...
const HotelCord = ({ hotel }: Props) => {
  return (
    <div>
      <div className="relative h-[300px] w-full rounded-lg cursor-pointer group overflow-hidden">
        {/* Add to favrite button */}
        ...
        <Image
          ...
          width={500}
          height={300}
          className="overflow-hidden w-full h-full object-cover group-hover:scale-110 transition-all duration-300"
        />
      </div>
      {/* Content */}
      <div className="">
